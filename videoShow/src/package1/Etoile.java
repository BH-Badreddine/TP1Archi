 ...
 */
public class Etoile extends FormeCirculaireReguliere implements IObjetDessinable {//la méthode dessiner() est héritée de la classe FormeCirculaireReguliere,donc elle est implémentée
